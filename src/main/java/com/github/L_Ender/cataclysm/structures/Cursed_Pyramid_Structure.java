            ...
            switch (function) {
                case "necklace" -> {
                    ...
                    worldIn.getBlockEntity(pos, BlockEntityType.BRUSHABLE_BLOCK).ifPresent((blockEntity) -> {
                        ResourceKey<LootTable> lootTableLocation = ResourceKey.create(Registries.LOOT_TABLE,ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "archaeology/cursed_pyramid_necklace"));
                ...
                case "sus" -> {
                    worldIn.setBlock(pos, Blocks.SUSPICIOUS_SAND.defaultBlockState(), 2);
                    worldIn.getBlockEntity(pos, BlockEntityType.BRUSHABLE_BLOCK).ifPresent((blockEntity) -> {
                        ResourceKey<LootTable> lootTableLocation = ResourceKey.create(Registries.LOOT_TABLE,ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "archaeology/cursed_pyramid"));
                        blockEntity.setLootTable(lootTableLocation, pos.asLong());
                    });
                }
                case "koboleton" -> {
                    ...
                    if (koboleton != null) {
                        ...
                        koboleton.finalizeSpawn(worldIn, worldIn.getCurrentDifficultyAt(koboleton.blockPosition()), MobSpawnType.STRUCTURE, (SpawnGroupData) null);
                ...
                case "wadjet" -> {
                    ...
                    if (wadjet != null) {
                        ...
                        wadjet.finalizeSpawn(worldIn, worldIn.getCurrentDifficultyAt(wadjet.blockPosition()), MobSpawnType.STRUCTURE, (SpawnGroupData) null);
                ...
                case "kobolediator" -> {
                    ...
                    if (kobolediator != null) {
                        ...
                        kobolediator.finalizeSpawn(worldIn, worldIn.getCurrentDifficultyAt(kobolediator.blockPosition()), MobSpawnType.STRUCTURE, (SpawnGroupData) null);
                ...
                case "remnant" -> {
                    ...
                    if (remnant != null) {
                        ...
                        remnant.finalizeSpawn(worldIn, worldIn.getCurrentDifficultyAt(remnant.blockPosition()), MobSpawnType.STRUCTURE, (SpawnGroupData) null);
