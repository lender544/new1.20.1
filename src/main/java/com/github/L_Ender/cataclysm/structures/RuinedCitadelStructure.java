...
public class RuinedCitadelStructure extends Structure {
    ...
    public static final MapCodec<RuinedCitadelStructure> CODEC = simpleCodec(RuinedCitadelStructure::new);

    private static final ResourceLocation CITADEL1 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel1");
    private static final ResourceLocation CITADEL2 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel2");
    private static final ResourceLocation CITADEL3 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel3");
    private static final ResourceLocation CITADEL4 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel4");
    private static final ResourceLocation CITADEL5 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel5");
    private static final ResourceLocation CITADEL6 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel6");
    private static final ResourceLocation CITADEL7 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel7");
    private static final ResourceLocation CITADEL8 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel8");
    private static final ResourceLocation CITADEL9 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel9");
    private static final ResourceLocation CITADEL10 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel10");
    private static final ResourceLocation CITADEL11 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel11");
    private static final ResourceLocation CITADEL12 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel12");
    private static final ResourceLocation CITADEL13 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel13");
    private static final ResourceLocation CITADEL14 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel14");
    private static final ResourceLocation CITADEL15 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel15");
    private static final ResourceLocation CITADEL16 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel16");
    private static final ResourceLocation CITADEL17 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel17");
    private static final ResourceLocation CITADEL18 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "ruined_citadel18");
