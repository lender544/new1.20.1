...
public class Burning_Arena_Structure extends Structure {
    ...
    public static final MapCodec<Burning_Arena_Structure> CODEC = simpleCodec(Burning_Arena_Structure::new);

    private static final ResourceLocation ARENA1 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "burning_arena1");
    private static final ResourceLocation ARENA2 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "burning_arena2");
    private static final ResourceLocation ARENA3 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "burning_arena3");
    private static final ResourceLocation ARENA4 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "burning_arena4");
    private static final ResourceLocation ARENA5 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "burning_arena5");
    private static final ResourceLocation ARENA6 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "burning_arena6");
    private static final ResourceLocation ARENA7 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "burning_arena7");
    private static final ResourceLocation ARENA8 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID, "burning_arena8");
