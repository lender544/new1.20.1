...
public final class CataclysmJigsawStructure extends Structure {
    public static final int MAX_TOTAL_STRUCTURE_RANGE = 128;
    public static final Codec<CataclysmJigsawStructure> CODEC = ExtraCodecs.validate(RecordCodecBuilder.mapCodec((p_227640_) -> {
        ...
        }), Codec.intRange(0, 15).fieldOf("size").forGetter((p_227652_) -> {
        ...
        })).apply(p_227640_, CataclysmJigsawStructure::new);
    }), CataclysmJigsawStructure::verifyRange).codec();
    ...
    private static DataResult<CataclysmJigsawStructure> verifyRange(CataclysmJigsawStructure p_286886_) {
        byte b0;
    ...
    public CataclysmJigsawStructure(Structure.StructureSettings p_227627_, Holder<StructureTemplatePool> p_227628_, Optional<ResourceLocation> p_227629_, int p_227630_, HeightProvider p_227631_, boolean p_227632_, Optional<Heightmap.Types> p_227633_, int p_227634_) {
        super(p_227627_);
    ...
    public CataclysmJigsawStructure(Structure.StructureSettings p_227620_, Holder<StructureTemplatePool> p_227621_, int p_227622_, HeightProvider p_227623_, boolean p_227624_, Heightmap.Types p_227625_) {
        this(p_227620_, p_227621_, Optional.empty(), p_227622_, p_227623_, p_227624_, Optional.of(p_227625_), 80);
    }

    public CataclysmJigsawStructure(Structure.StructureSettings p_227614_, Holder<StructureTemplatePool> p_227615_, int p_227616_, HeightProvider p_227617_, boolean p_227618_) {
    ...
    public StructureType<?> type() {
        return ModStructures.CATACLYSM_JIGSAW.get();
    }
}
