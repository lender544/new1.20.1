...
public class Drowned_Host_Entity extends Zombie implements RangedAttackMob {
    ...
    public Drowned_Host_Entity(EntityType<? extends Drowned_Host_Entity> entityType, Level level) {
        ...
        this.moveControl = new Drowned_Host_Entity.DrownedMoveControl(this);
    ...
    protected void addBehaviourGoals() {
        this.goalSelector.addGoal(1, new Drowned_Host_Entity.DrownedGoToWaterGoal(this, 1.0));
        this.goalSelector.addGoal(2, new Drowned_Host_Entity.DrownedTridentAttackGoal(this, 1.0, 40, 10.0F));
        this.goalSelector.addGoal(2, new ZombieAttackGoal(this, 1.0, false));
        this.goalSelector.addGoal(5, new Drowned_Host_Entity.DrownedGoToBeachGoal(this, 1.0));
        this.goalSelector.addGoal(6, new Drowned_Host_Entity.DrownedSwimUpGoal(this, 1.0, this.level().getSeaLevel()));
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor accessor, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {
        ...
        EventHooks.finalizeMobSpawn(upper, accessor, difficulty, spawnType, spawnGroupData);
    ...
    public static boolean checkDrownedSpawnRules(
            EntityType<Drowned_Host_Entity> drowned, ServerLevelAccessor serverLevel, MobSpawnType mobSpawnType, BlockPos pos, RandomSource random
    ) {
