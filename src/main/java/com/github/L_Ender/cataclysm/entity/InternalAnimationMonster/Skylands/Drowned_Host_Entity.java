...
public class Drowned_Host_Entity extends Zombie implements RangedAttackMob {
    ...
    public Drowned_Host_Entity(EntityType<? extends Drowned_Host_Entity> p_32344_, Level p_32345_) {
    ...
    static class DrownedGoToBeachGoal extends MoveToBlockGoal {
        ...
        public DrownedGoToBeachGoal(Drowned_Host_Entity p_32409_, double p_32410_) {
    ...
    static class DrownedMoveControl extends MoveControl {
        ...
        public DrownedMoveControl(Drowned_Host_Entity p_32433_) {
            super(p_32433_);
    ...
    static class DrownedSwimUpGoal extends Goal {
        ...
        public DrownedSwimUpGoal(Drowned_Host_Entity p_32440_, double p_32441_, int p_32442_) {
    ...
    static class DrownedTridentAttackGoal extends RangedAttackGoal {
        ...
        public DrownedTridentAttackGoal(RangedAttackMob p_32450_, double p_32451_, int p_32452_, float p_32453_) {
            ...
            this.drowned = (Drowned_Host_Entity)p_32450_;
        }
