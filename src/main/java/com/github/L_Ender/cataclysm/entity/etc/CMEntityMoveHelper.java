    ...
    public void tick()
    {
        if (this.operation == Operation.STRAFE)
        {
            ...
            if (pathnavigate != null)
            {
                ...
                if (nodeprocessor != null && nodeprocessor.getPathType(this.mob, BlockPos.containing(Mth.floor(this.mob.getX() + (double)f7), Mth.floor(this.mob.getY()), Mth.floor(this.mob.getZ() + (double)f8))) != PathType.WALKABLE) {
