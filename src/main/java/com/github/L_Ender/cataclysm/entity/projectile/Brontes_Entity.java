...
public class Brontes_Entity extends AbstractArrow implements IEntityAdditionalSpawnData {
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(STORM_DAMAGE, 0F);
	}
	...
	protected ItemStack getPickupItem() {
		return new ItemStack(ModItems.BRONTES.get());
	}
