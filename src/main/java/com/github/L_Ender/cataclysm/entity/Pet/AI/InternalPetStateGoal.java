...
public class InternalPetStateGoal extends Goal {
    ...
    public InternalPetStateGoal(InternalAnimationPet entity, int getattackstate, int attackstate, int attackendstate, int attackfinaltick, int attackseetick, EnumSet<Flag> interruptFlagTypes) {
        this.entity = entity;
