...
public class Armortier {
 ...
 public static final DeferredHolder<ArmorMaterial, ArmorMaterial> IGNITIUM = ARMOR_MATERIALS.register("ignitium", () ->
 ...
 }), 15, SoundEvents.ARMOR_EQUIP_NETHERITE, () -> Ingredient.of(ModItems.CURSIUM_INGOT.get()), List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"cursium"))), 4.0F, 0.05F));
 ...
 public static final DeferredHolder<ArmorMaterial, ArmorMaterial> BONE_REPTILE = ARMOR_MATERIALS.register("bone_reptile", () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
     ...
     map.put(ArmorItem.Type.HELMET, 6);
     map.put(ArmorItem.Type.BODY, 13);
 }), 15, SoundEvents.ARMOR_EQUIP_NETHERITE, () -> Ingredient.of(ModItems.ANCIENT_METAL_INGOT.get()), List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"bone_reptile"))), 2.5F, 0.25F));
}
