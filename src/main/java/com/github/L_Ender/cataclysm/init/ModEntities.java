...
import com.github.L_Ender.cataclysm.entity.Pet.Summoned_Entity.Ignited_Sword_Entity;
...
public class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>,EntityType<SkyColor_Entity>> SKY_COLOR = ENTITY_TYPE.register("sky_color", () -> EntityType.Builder.<SkyColor_Entity>of(SkyColor_Entity::new, MobCategory.MISC)
            .sized(0.0f, 0.0f)
            .setUpdateInterval(Integer.MAX_VALUE)
    ...
    public static final DeferredHolder<EntityType<?>,EntityType<Storm_Serpent_Entity>> STORM_SERPENT = ENTITY_TYPE.register("storm_serpent", () -> EntityType.Builder.<Storm_Serpent_Entity>of(Storm_Serpent_Entity::new, MobCategory.MISC)
            .sized(2.0F, 9.0F)
            .clientTrackingRange(6)
            .updateInterval(2)
            .fireImmune()
    ...
    public static final DeferredHolder<EntityType<?>,EntityType<Scylla_Ceraunus_Entity>> SCYLLA_CERAUNUS = ENTITY_TYPE.register("scylla_ceraunus", () -> EntityType.Builder.<Scylla_Ceraunus_Entity>of(Scylla_Ceraunus_Entity::new, MobCategory.MISC)
            .sized(1.5F, 1.5F)
            .clientTrackingRange(4)
    ...
    public static final DeferredHolder<EntityType<?>,EntityType<Brontes_Entity>> BRONTES = ENTITY_TYPE.register("brontes", () -> EntityType.Builder.<Brontes_Entity>of(Brontes_Entity::new, MobCategory.MISC)
            .sized(1.5F, 1.5F)
            .clientTrackingRange(4)
            .passengerAttachments(0.5F)
            .updateInterval(20)
    ...
    public static final DeferredHolder<EntityType<?>,EntityType<Drowned_Host_Entity>> DROWNED_HOST = ENTITY_TYPE.register("drowned_host", () -> EntityType.Builder.of(Drowned_Host_Entity::new, MobCategory.MONSTER)
            .sized(0.6F, 1.95F)
            .eyeHeight(1.74F)
    ...
    public static final DeferredHolder<EntityType<?>,EntityType<Octo_Ink_Entity>> OCTO_INK = ENTITY_TYPE.register("octo_ink", () -> EntityType.Builder.<Octo_Ink_Entity>of(Octo_Ink_Entity::new, MobCategory.MISC)
            .sized(0.25F, 0.25F)
            .clientTrackingRange(4)
            .updateInterval(10)
    ...
    public static void registerSpawnPlacements(RegisterSpawnPlacementsEvent event) {
        ...
        event.register(AMETHYST_CRAB.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Amethyst_Crab_Entity::canCrabSpawnSpawnRules,RegisterSpawnPlacementsEvent.Operation.REPLACE);
