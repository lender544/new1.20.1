...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<SkyColor_Entity>> SKY_COLOR = ENTITY_TYPE.register("sky_color", () -> EntityType.Builder.<SkyColor_Entity>of(SkyColor_Entity::new, MobCategory.MISC)
            .sized(0.0f, 0.0f)
            .setUpdateInterval(Integer.MAX_VALUE)
            .build(Cataclysm.MODID + ":sky_color"));
    ...
    public static final RegistryObject<EntityType<Bolt_strike_Entity>> BOLT_STRIKE = ENTITY_TYPE.register("bolt_strike", () -> EntityType.Builder.<Bolt_strike_Entity>of(Bolt_strike_Entity::new, MobCategory.MISC)
            .sized(0.0F, 0.0F)
    ...
    public static final RegistryObject<EntityType<Brontes_Entity>> BRONTES = ENTITY_TYPE.register("brontes", () -> EntityType.Builder.<Brontes_Entity>of(Brontes_Entity::new, MobCategory.MISC)
            .sized(1.5F, 1.5F)
            .clientTrackingRange(4)
            .updateInterval(20)
            .build(Cataclysm.MODID + ":brontes"));
    ...
    public static void registerSpawnPlacements(SpawnPlacementRegisterEvent event) {
        event.register(ENDERMAPTERA.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Endermaptera_Entity::canSpawn,SpawnPlacementRegisterEvent.Operation.AND);
        event.register(KOBOLETON.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Koboleton_Entity::checkKoboletonSpawnRules,SpawnPlacementRegisterEvent.Operation.AND);
        event.register(DEEPLING_ANGLER.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Deepling_Angler_Entity::candeeplingSpawn,SpawnPlacementRegisterEvent.Operation.AND);
        event.register(DEEPLING.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Deepling_Entity::candeeplingSpawn,SpawnPlacementRegisterEvent.Operation.AND);
        event.register(DEEPLING_BRUTE.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Deepling_Brute_Entity::candeeplingSpawn,SpawnPlacementRegisterEvent.Operation.AND);
        event.register(DEEPLING_WARLOCK.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Deepling_Warlock_Entity::candeeplingSpawn,SpawnPlacementRegisterEvent.Operation.AND);
        event.register(DEEPLING_PRIEST.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Deepling_Priest_Entity::candeeplingSpawn,SpawnPlacementRegisterEvent.Operation.AND);
        event.register(CORAL_GOLEM.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Coral_Golem_Entity::cangolemSpawn,SpawnPlacementRegisterEvent.Operation.AND);
        event.register(AMETHYST_CRAB.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Amethyst_Crab_Entity::canCrabSpawnSpawnRules,SpawnPlacementRegisterEvent.Operation.AND);
        event.register(IGNITED_BERSERKER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Monster::checkAnyLightMonsterSpawnRules,SpawnPlacementRegisterEvent.Operation.AND);
    }
