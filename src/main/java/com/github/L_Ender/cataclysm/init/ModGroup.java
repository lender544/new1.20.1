...
public class ModGroup {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> ITEM = DEF_REG.register("cataclysm_item", () -> CreativeModeTab.builder()
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> BLOCK = DEF_REG.register("cataclysm_block", () -> CreativeModeTab.builder()
            ...
            .displayItems((enabledFeatures, entries) -> {
                ...
                entries.accept(ModItems.ALTAR_OF_FIRE.get());
                entries.accept(ModItems.ALTAR_OF_VOID.get());
                entries.accept(ModItems.ALTAR_OF_AMETHYST.get());
                entries.accept(ModItems.ALTAR_OF_ABYSS.get());
                entries.accept(ModItems.CURSED_TOMBSTONE.get());
    ...
    private static void createLaserGatling(CreativeModeTab.Output output) {
        ItemStack loreSword = new ItemStack(ModItems.LASER_GATLING.get());
