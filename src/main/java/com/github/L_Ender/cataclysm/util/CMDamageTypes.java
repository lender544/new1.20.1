...
public class CMDamageTypes {
    ...
    public static final ResourceKey<DamageType> PLAYER_CERAUNUS = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"player_ceraunus"));
    ...
    public static final ResourceKey<DamageType> STAR_LANCE = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"star_lance"));


    public static final ResourceKey<DamageType> DRACONIC_WOUND = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"draconic_wound"));
    public static final ResourceKey<DamageType> DRACONIC_SLASH = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"draconic_slash"));
    public static final ResourceKey<DamageType> DRACONIC_WOUND_ERUPTION = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"draconic_wound_eruption"));

    public static final ResourceKey<DamageType> DAGGER = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"dagger"));
