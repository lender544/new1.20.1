...
public class CommonConfig {
    ...
    public CommonConfig(final ForgeConfigSpec.Builder builder) {
        ...
        EnderguardianNatureHealing = buildDouble(builder, "EnderGuardianNatureHealing", "all", 20D, 0D, 1000000D, "EnderGuardian's Healing with out target");
        ...
        MonstrosityNatureHealing = buildDouble(builder, "MonstrosityNatureHealing", "all", 20D, 0D, 1000000D, " Monstrosity's Healing with out target");
        ...
        IgnisNatureHealing = buildDouble(builder, "IgnisNatureHealing", "all", 20D, 0D, 1000000D, "Ignis's Healing with out target");
        ...
        LeviathanNatureHealing = buildDouble(builder, "LeviathanNatureHealing", "all", 20D, 0D, 1000000D, "Leviathan's Healing with out target");
        ...
        AncientRemnantNatureHealing = buildDouble(builder, "AncientRemnantNatureHealing", "all", 20D, 0D, 1000000D, "AncientRemnant's Healing with out target");
        ...
        MaledictusNatureHealing = buildDouble(builder, "MaledictusNatureHealing", "all", 20D, 0D, 1000000D, "Maledictus's Healing with out target");
