...
public class Urchinkin_Renderer extends MobRenderer<Urchinkin_Entity, Urchinkin_Model> {
    private static final ResourceLocation URCHIN_TEXTURES = new ResourceLocation(Cataclysm.MODID,"textures/entity/sea/urchinkin.png");
    private static final ResourceLocation MEAT_BOY = new ResourceLocation(Cataclysm.MODID,"textures/entity/sea/meat_boy.png");
