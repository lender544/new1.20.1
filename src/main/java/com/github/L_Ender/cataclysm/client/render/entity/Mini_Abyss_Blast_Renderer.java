...
@OnlyIn(Dist.CLIENT)
public class Mini_Abyss_Blast_Renderer extends EntityRenderer<Mini_Abyss_Blast_Entity> {
    ...
    private void renderFlatQuad(int frame, PoseStack matrixStackIn, VertexConsumer builder, int packedLightIn) {
        ...
        drawVertex( matrixstack$entry, builder, -START_RADIUS, -END_RADIUS, 0, minU, minV, 1, packedLightIn);
        drawVertex( matrixstack$entry, builder, -START_RADIUS, END_RADIUS, 0, minU, maxV, 1, packedLightIn);
        drawVertex(matrixstack$entry, builder, START_RADIUS, END_RADIUS, 0, maxU, maxV, 1, packedLightIn);
        drawVertex( matrixstack$entry, builder, START_RADIUS, -END_RADIUS, 0, maxU, minV, 1, packedLightIn);
    }
