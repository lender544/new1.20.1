...
public class Deepling_Renderer extends MobRenderer<Deepling_Entity, Deepling_Model> {
    ...
    private static final ResourceLocation SSAPBUG_TEXTURES = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/deepling/deepling_1.png");
    private static final ResourceLocation DEEPLING_LAYER_TEXTURES  = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/deepling/deepling_layer.png");
