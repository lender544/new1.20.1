...
public class ModelDeepling_Brute extends AdvancedEntityModel<Deepling_Brute_Entity> {
	...
	private final AdvancedModelPart l_armor;
	private final AdvancedModelPart left_arm_r1;
	...
	public ModelDeepling_Brute() {
		...
		l_armor = new AdvancedModelPart(this);
		...
		left_arm_r1 = new AdvancedModelPart(this);
