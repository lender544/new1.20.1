...
public class Berserker_Soul_Amulet_Renderer implements ICurioRenderer {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(Cataclysm.MODID,"textures/curiositem/berserker_soul_amulet.png");
    private static final ResourceLocation TEXTURE_LAYER = new ResourceLocation(Cataclysm.MODID,"textures/curiositem/berserker_soul_amulet_layer.png");
    ...
    protected void renderArm(Berserker_Soul_Amulet_Model model, PoseStack matrixStack, MultiBufferSource buffer, int light, boolean hasFoil) {
        ...
        model.renderToBuffer(matrixStack, builder, LightTexture.pack(15, 15), OverlayTexture.NO_OVERLAY,1.0F,1.0F,1.0f,1.0f);
