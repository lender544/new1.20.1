...
public class Elite_Draugr_Renderer extends MobRenderer<Elite_Draugr_Entity, Elite_Draugr_Model> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/draugar/elite_draugr.png");
    private static final ResourceLocation LAYER = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/draugar/elite_draugr_layer.png");
