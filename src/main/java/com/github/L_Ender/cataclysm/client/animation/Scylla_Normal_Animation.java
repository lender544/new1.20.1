...
public class Scylla_Normal_Animation {
    public static final AnimationDefinition IDLE = AnimationDefinition.Builder.withLength(3.125F).looping()
        ...
        public static final AnimationDefinition WALK = AnimationDefinition.Builder.withLength(1.25F).looping()
                ...
                .addAnimation("anker", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
        ...
        public static final AnimationDefinition SMASH = AnimationDefinition.Builder.withLength(2.0F)
                ...
                .addAnimation("anker", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
        ...
        public static final AnimationDefinition ANCHOR_SPIN_ATTACK = AnimationDefinition.Builder.withLength(4.3333F)
                ...
                .addAnimation("anker", new AnimationChannel(AnimationChannel.Targets.SCALE,
                ...
                .addAnimation("chain_anker", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
