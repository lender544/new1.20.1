...
public class ModelNameless_Sorcerer extends AdvancedEntityModel<Nameless_Sorcerer_Entity> {
    ...
    private final AdvancedModelPart headwear;
    private final AdvancedModelPart nose;
    private final AdvancedModelPart body;
    private final AdvancedModelPart bodywear;
    ...
    private final AdvancedModelPart book;
    private final AdvancedModelPart cover_right;
    private final AdvancedModelPart cover_left;
    private final AdvancedModelPart filpping_page_right;
    private final AdvancedModelPart page_right;
    private final AdvancedModelPart page_left;
    private final AdvancedModelPart filpping_page_left;
    ...
    public ModelNameless_Sorcerer() {
        ...
        bodywear = new AdvancedModelPart(this);
        ...
        book = new AdvancedModelPart(this);
        ...
        cover_right = new AdvancedModelPart(this);
        ...
        cover_left = new AdvancedModelPart(this);
        ...
        filpping_page_right = new AdvancedModelPart(this);
        ...
        page_right = new AdvancedModelPart(this);
        ...
        page_left = new AdvancedModelPart(this);
        ...
        filpping_page_left = new AdvancedModelPart(this);
