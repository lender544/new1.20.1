...
public class Maledictus_Renderer extends MobRenderer<Maledictus_Entity, Maledictus_Model> {
    ...
    private static final ResourceLocation MALEDICTUS_TEXTURES = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/maledictus/maledictus_armor.png");
