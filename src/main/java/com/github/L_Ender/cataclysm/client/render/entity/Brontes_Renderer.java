...
public class Brontes_Renderer extends EntityRenderer<Brontes_Entity> {
	...
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/item/brontes.png");

	private static final ResourceLocation TEXTURE_LAYER = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/item/brontes_layer.png");
