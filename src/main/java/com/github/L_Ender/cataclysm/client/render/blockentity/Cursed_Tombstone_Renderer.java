...
public class Cursed_Tombstone_Renderer implements BlockEntityRenderer<Cursed_tombstone_Entity> {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/block/cursed_tombstone_off.png");
    private static final ResourceLocation TEXTURE2 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/block/cursed_tombstone_on.png");
   private static final Cursed_Tombstone_Model MODEL = new Cursed_Tombstone_Model();
    ...
    public void render(Cursed_tombstone_Entity entity, float delta, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int overlay) {
        ...
        MODEL.renderToBuffer(poseStack,entity.getBlockState().getValue(Cursed_Tombstone_Block.POWERED) ? buffer.getBuffer(RenderType.entityCutoutNoCull(TEXTURE2)) :  buffer.getBuffer(RenderType.entityCutoutNoCull(TEXTURE)), packedLight, overlay);
