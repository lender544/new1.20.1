...
public class Ignis_Armor_Crack_Layer extends RenderLayer<Ignis_Entity, Ignis_Model> {
    ...
    private static final Map<Ignis_Entity.Crackiness, ResourceLocation> resourceLocations = ImmutableMap.of(
            Ignis_Entity.Crackiness.LOW, ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/ignis/ignis_armor_crack1.png"),
            Ignis_Entity.Crackiness.MEDIUM, ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/ignis/ignis_armor_crack2.png"),
            Ignis_Entity.Crackiness.HIGH, ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/ignis/ignis_armor_crack3.png"));
        ...
        if (!ignis.isInvisible()) {
            if(ignis.getBossPhase() > 0){
                ...
                if (ignis$crackiness != Ignis_Entity.Crackiness.NONE) {
                    ...
                    renderColoredCutoutModel(this.getParentModel(), resourcelocation, matrixStackIn, bufferIn, packedLightIn, ignis, -1);
                }
            }
        }
