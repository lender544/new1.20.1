...
public class Maledictus_Layer extends RenderLayer<Maledictus_Entity, Maledictus_Model> {
    private static final ResourceLocation LAYER_TEXTURES  = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/maledictus/maledictus_ghost.png");
