...
public class ModelAxe_Blade extends AdvancedEntityModel<Axe_Blade_Entity> {
	...
	public void setupAnim(Axe_Blade_Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animate(entityIn.getAnimationState("one"), Phantom_Halberd_Animation.ONE, ageInTicks, 1.0F);
	}
}