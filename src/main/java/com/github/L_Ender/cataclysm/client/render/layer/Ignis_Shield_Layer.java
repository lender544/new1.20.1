...
public class Ignis_Shield_Layer extends RenderLayer<Ignis_Entity, Ignis_Model> {
    ...
    private static final ResourceLocation IGNIS_SHIELD = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/ignis/ignis_shield.png");

    private static final ResourceLocation IGNIS_SOUL_SHIELD = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/ignis/ignis_soul_shield.png");

    private static final ResourceLocation IGNIS_SHIELD_CRACK1 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/ignis/ignis_shield_crack1.png");

    private static final ResourceLocation IGNIS_SHIELD_CRACK2 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/ignis/ignis_shield_crack2.png");

    private static final ResourceLocation IGNIS_SHIELD_CRACK3 = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/ignis/ignis_shield_crack3.png");
