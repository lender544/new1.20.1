...
public class Wadjet_Model extends AdvancedEntityModel<Wadjet_Entity> {
	...
	public void renderToBuffer(PoseStack matrixStackIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, int alpha) {
		...
		if (tail != null) tail.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, alpha, tailDynamic);
