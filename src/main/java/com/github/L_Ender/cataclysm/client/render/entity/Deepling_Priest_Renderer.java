...
public class Deepling_Priest_Renderer extends MobRenderer<Deepling_Priest_Entity, Deepling_Priest_Model> {
    ...
    private static final ResourceLocation DEEPLING_TEXTURES = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/deepling/deepling_priest.png");
    private static final ResourceLocation DEEPLING_LAYER_TEXTURES  = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/deepling/deepling_priest_layer.png");
