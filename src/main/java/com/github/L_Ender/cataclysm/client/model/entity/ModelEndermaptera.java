...
public class ModelEndermaptera extends AdvancedEntityModel<Endermaptera_Entity> {
	...
	public final AdvancedModelPart abdomen;
	public final AdvancedModelPart head;
	public final AdvancedModelPart head_left;
	public final AdvancedModelPart head_right;
	public final AdvancedModelPart head_top;
	public final AdvancedModelPart left_antenna;
	public final AdvancedModelPart right_antenna;
	public final AdvancedModelPart right_jaw;
	public final AdvancedModelPart left_jaw;
	public final AdvancedModelPart right_leg_front;
	public final AdvancedModelPart left_leg_front;
	public final AdvancedModelPart right_leg_mid;
	public final AdvancedModelPart left_leg_mid;
	public final AdvancedModelPart right_leg_back;
	public final AdvancedModelPart left_leg_back;
	...
	public ModelEndermaptera() {
		...
		abdomen = new AdvancedModelPart(this);
		...
		head_left = new AdvancedModelPart(this);
		...
		head_right = new AdvancedModelPart(this);
		...
		head_top = new AdvancedModelPart(this);
		...
		left_antenna = new AdvancedModelPart(this);
		...
		right_antenna = new AdvancedModelPart(this);
		...
		right_leg_front = new AdvancedModelPart(this);
		...
		left_leg_front = new AdvancedModelPart(this);
		...
		right_leg_mid = new AdvancedModelPart(this);
		...
		left_leg_mid = new AdvancedModelPart(this);
		...
		right_leg_back = new AdvancedModelPart(this);
		...
		left_leg_back = new AdvancedModelPart(this);
