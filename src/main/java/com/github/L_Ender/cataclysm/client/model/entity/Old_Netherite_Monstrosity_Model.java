...
public class Old_Netherite_Monstrosity_Model extends AdvancedEntityModel<Old_Netherite_Monstrosity_Entity> {
	...
	public Old_Netherite_Monstrosity_Model() {
		texWidth = 512;
		texHeight = 512;
	...
	public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
		...
		animator.setAnimation(Old_Netherite_Monstrosity_Entity.MONSTROSITY_CHARGE);
		...
		animator.setAnimation(Old_Netherite_Monstrosity_Entity.MONSTROSITY_ERUPTIONATTACK);
		animator.startKeyframe(10);
		...
		animator.setAnimation(Old_Netherite_Monstrosity_Entity.MONSTROSITY_EARTHQUAKE);
		...
		animator.setAnimation(Old_Netherite_Monstrosity_Entity.MONSTROSITY_EARTHQUAKE2);
		...
		animator.setAnimation(Old_Netherite_Monstrosity_Entity.MONSTROSITY_EARTHQUAKE3);
		...
		animator.setAnimation(Old_Netherite_Monstrosity_Entity.MONSTROSITY_BERSERK);
		animator.startKeyframe(16);
		animator.rotate(upperbody, (float)Math.toRadians(-15F), 0, 0);
		animator.rotate(lowerbody, (float)Math.toRadians(-25F), 0, 0);
		animator.move(rightleg, 0, -6, -6);
		...
		animator.setAnimation(Old_Netherite_Monstrosity_Entity.MONSTROSITY_DEATH);
	...
	@Override
	public void setupAnim(Old_Netherite_Monstrosity_Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
