...
public class ModelThe_Watcher extends AdvancedEntityModel<The_Watcher_Entity> {
	...
	public ModelThe_Watcher() {
		...
		pivot = new AdvancedModelBox(this);
		...
		cannon = new AdvancedModelBox(this);
		...
		sail = new AdvancedModelBox(this);
		...
		sail2 = new AdvancedModelBox(this);
		...
		booster = new AdvancedModelBox(this);
		...
		upper_sub_booster = new AdvancedModelBox(this);
		...
		lower_sub_booster = new AdvancedModelBox(this);
