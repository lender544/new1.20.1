...
public class Maledictus_Normal_Attack_Animation {
    ...
    public static final AdvancedAnimationDefinition SPIN_SLASHES = AdvancedAnimationDefinition.Builder.withLength(3.375F)
            ...
            .addAnimation("left_shoulder", new AdvancedAnimationChannel(AdvancedAnimationChannel.Targets.ROTATION,
                    ...
                    new AdvancedKeyframe(0.9583F, AdvancedKeyframeAnimations.degreeVec(-107.2247F, 53.8857F, -58.5988F), AdvancedAnimationChannel.Interpolations.CATMULLROM),
                    new AdvancedKeyframe(1.0F, AdvancedKeyframeAnimations.degreeVec(-77.0133F, 61.6946F, -37.2352F), AdvancedAnimationChannel.Interpolations.CATMULLROM),
                    new AdvancedKeyframe(1.0833F, AdvancedKeyframeAnimations.degreeVec(-65.1813F, 58.8432F, -32.9049F), AdvancedAnimationChannel.Interpolations.CATMULLROM),
                    new AdvancedKeyframe(1.2917F, AdvancedKeyframeAnimations.degreeVec(-31.5786F, 4.9553F, -22.0838F), AdvancedAnimationChannel.Interpolations.CATMULLROM),
                    new AdvancedKeyframe(1.4583F, AdvancedKeyframeAnimations.degreeVec(10.1482F, -71.3558F, -69.363F), AdvancedAnimationChannel.Interpolations.LINEAR),
                    new AdvancedKeyframe(1.625F, AdvancedKeyframeAnimations.degreeVec(-40.3703F, -71.8836F, -34.0946F), AdvancedAnimationChannel.Interpolations.LINEAR),
            ...
            .addAnimation("left_wing", new AdvancedAnimationChannel(AdvancedAnimationChannel.Targets.ROTATION,
                    ...
                    new AdvancedKeyframe(2.25F, AdvancedKeyframeAnimations.degreeVec(0.0F, 49.46F, 0.0F), AdvancedAnimationChannel.Interpolations.CATMULLROM),
                    new AdvancedKeyframe(2.75F, AdvancedKeyframeAnimations.degreeVec(0.0F, 1.48F, 0.0F), AdvancedAnimationChannel.Interpolations.CATMULLROM),
                    new AdvancedKeyframe(3.375F, AdvancedKeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AdvancedAnimationChannel.Interpolations.CATMULLROM)
            ))
            .addAnimation("left_wing2", new AdvancedAnimationChannel(AdvancedAnimationChannel.Targets.ROTATION,
                    ...
                    new AdvancedKeyframe(2.25F, AdvancedKeyframeAnimations.degreeVec(0.0F, -30.02F, 0.0F), AdvancedAnimationChannel.Interpolations.CATMULLROM),
                    new AdvancedKeyframe(2.75F, AdvancedKeyframeAnimations.degreeVec(0.0F, -50.36F, 0.0F), AdvancedAnimationChannel.Interpolations.CATMULLROM),
                    new AdvancedKeyframe(3.375F, AdvancedKeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AdvancedAnimationChannel.Interpolations.CATMULLROM)
            ))
            .addAnimation("right_wing", new AdvancedAnimationChannel(AdvancedAnimationChannel.Targets.ROTATION,
                    ...
                    new AdvancedKeyframe(1.25F, AdvancedKeyframeAnimations.degreeVec(0.0F, 60.62F, 0.0F), AdvancedAnimationChannel.Interpolations.CATMULLROM),
            ...
            .addAnimation("left_mace", new AdvancedAnimationChannel(AdvancedAnimationChannel.Targets.ROTATION,
                    ...
                    new AdvancedKeyframe(1.0833F, AdvancedKeyframeAnimations.degreeVec(55.3255F, 7.1735F, 5.7795F), AdvancedAnimationChannel.Interpolations.CATMULLROM),
                    new AdvancedKeyframe(1.1667F, AdvancedKeyframeAnimations.degreeVec(37.738F, 5.9438F, 4.5822F), AdvancedAnimationChannel.Interpolations.CATMULLROM),
