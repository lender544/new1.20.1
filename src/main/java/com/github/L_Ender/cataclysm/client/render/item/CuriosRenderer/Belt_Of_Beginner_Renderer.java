...
public class Belt_Of_Beginner_Renderer implements ICurioRenderer {
    private final Belt_Of_Beginner_Model model;
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/curiositem/belt_of_beginner.png");

    public Belt_Of_Beginner_Renderer() {
        this.model = new Belt_Of_Beginner_Model(Minecraft.getInstance().getEntityModels().bakeLayer(CMModelLayers.BELT_OF_BEGINNER_MODEL));
    }
