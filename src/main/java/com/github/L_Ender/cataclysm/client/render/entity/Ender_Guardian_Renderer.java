...
public class Ender_Guardian_Renderer extends MobRenderer<Ender_Guardian_Entity, Ender_Guardian_Model> {
    ...
    private static final ResourceLocation ENDER_GUARDIAN_TEXTURES = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,"textures/entity/ender_guardian.png");
