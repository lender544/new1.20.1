...
@OnlyIn(Dist.CLIENT)
public class Ancient_Ancient_Remnant_Layer extends RenderLayer<Ancient_Ancient_Remnant_Entity, ModelAncient_Remnant> {
    ...
    public Ancient_Ancient_Remnant_Layer(RendererAncient_Remnant renderIn) {
        super(renderIn);
