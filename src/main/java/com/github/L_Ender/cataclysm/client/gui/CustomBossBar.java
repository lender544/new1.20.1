...
public class CustomBossBar {
    ...
    static {
        ...
        customBossBars.put(12, new CustomBossBar(
                new ResourceLocation(Cataclysm.MODID, "textures/gui/boss_bar/scylla_bar_base.png"),
                new ResourceLocation(Cataclysm.MODID, "textures/gui/boss_bar/scylla_bar_overlay.png"),
