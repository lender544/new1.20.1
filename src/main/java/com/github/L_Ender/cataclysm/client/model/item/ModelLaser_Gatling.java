...
public class ModelLaser_Gatling extends AdvancedEntityModel<Entity> {
    ...
    public ModelLaser_Gatling() {
        ...
        core_root = new AdvancedModelPart(this);
        ...
        gatling = new AdvancedModelPart(this);
